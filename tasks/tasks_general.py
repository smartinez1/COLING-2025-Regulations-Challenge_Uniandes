...
import logging
import argparse
from prompts import PROMPT_ABBREV, PROMPT_DEFS, PROMPT_LINKS, SYSTEM_PROMPT_GENERAL, QA_SYSTEM, PROMPT_QA_TASK, CDM_SYSTEM, PROMPT_CDM_TASK
from sources import ABBREV, LINKS, DEFS, QA_TASK
...
async def main():
    ...
    parser.add_argument("task", type=str, choices=["abbrev", "definitions", "links","qa_task","cdm_task"], help="The task to execute: 'classif' for classification, 'cleaning' for data cleaning.")
